 ...
 *
 * In this struct, we store the indices of the 4 vertices, the indices of the
 ...
 *
 * Conventions:
 * 1. neighbours[i] is the tetrahedron sharing the face oposite of vertices[i].
...
/**
 * @brief Initialize a tetrahedron with the given vertices.
 *
